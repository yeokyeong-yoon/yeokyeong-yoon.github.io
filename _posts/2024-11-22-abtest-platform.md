...
데이터 기반 의사결정은 현대 기업의 핵심 경쟁력이 되었습니다. 특히 어느정도 규모가 있는 IT 서비스 기업에서는 A/B 테스트와 같은 실험을 통해 새로운 기능이나 디자인의 효과를 검증하는 것이 일상적인 업무가 되었습니다. 야놀자에서도 이러한 흐름에 맞춰 실험 플랫폼을 발전시켜 왔습니다. 이 글에서는 야놀자 실험 플랫폼이 어떻게 단순한 ML 모델 평가 도구에서 전사적 데이터 기반 의사결정 인프라로 진화했는지 그 여정을 공유하고자 합니다. 
...
#### f) 실험 전담팀의 부재
Data 팀 내에 실험 프로젝트는 시니어 엔지니어인 팀장님과 1명과 저를 포함한 주니어 엔지니어 2명이 담당했는데, 팀장님은 여러 책임을 동시에 맡고 있어 실질적으로는 주니어 엔지니어 2명이 실험 플랫폼을 운영해야 했습니다. 리소스 부족으로 "실험 플랫폼"이라는 도구 제공 이상의 역할을 수행하기 어려웠습니다.
...
앞으로, 실험 플랫폼 서비스와 팀이 확장하게 되다면  야놀자의 실험 플랫폼은 모든 개발 팀이 손쉽게 실험을 수행하고, 서비스 품질을 지속적으로 개선할 수 있는 핵심 인프라로 자리 잡을 것입니다. 앞으로도 실험 플랫폼은 야놀자의 데이터 기반 의사결정 문화를 선도하며, 서비스 성장과 혁신을 지원하는 중요한 역할을 수행할 것입니다.